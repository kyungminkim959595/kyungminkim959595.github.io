...
<div class="row justify-content-sm-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    {% include figure.liquid
       ...
       title='Figure 1. Case of bias amplification in Text-to-Image generation <d-cite key="seshadri2024bias"></d-cite>'
...
<div class="row justify-content-sm-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    {% include figure.liquid
       ...
       caption='Figure 2. source from <d-cite key="kim2024rethinking"></d-cite>' 
       class="img-fluid rounded z-depth-1" 
       width="80%" %}
  </div>
</div>
...
<div class="row justify-content-sm-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    {% include figure.liquid
       ...
       caption='Figure 3. Visualization of Diffusion processes. Source from <d-cite key="songscore"></d-cite>'
       class="img-fluid rounded z-depth-1" %}
  </div>
</div>
...
<div class="row justify-content-sm-center">
  <div class="col-sm-10 mt-3 mt-md-0">
    {% include figure.liquid
       ...
       caption='Figure 7. Gender ratio reported in <d-cite key="cho2023dall"></d-cite>, -0.42 maps to 0.34 on a 0–1 scale.'
       class="img-fluid rounded z-depth-1" 
       width="60%" %}
  </div>
</div>
