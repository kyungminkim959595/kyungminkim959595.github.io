...
<div class="caption">
  Figure 1. Case of bias amplification in Text-to-Image generation (Seshadri et al., 2024)
</div>
...
<div class="caption">
  Figure 2. Source from <d-cite key="kim2024rethinking"></d-cite>.
</div>

In this blog post, we analyze how CFG drives bias amplification in T2I diffusion models. Our work proceeds in three steps: (1) we formulate the problem by surveying prior research on CFG’s impact on model distributions; (2) we quantitatively assess the degree to which CFG contributes to bias amplification; and (3) we characterize the relationship between guidance scale and bias trends. We conducted our experimental analysis on the gender–occupation bias, a primary focus in fairness studies of text-to-image generative models.
