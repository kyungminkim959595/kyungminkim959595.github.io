...
- From the previous work that identified the bias amplification problem and conducted similar analyses <d-cite key="kim2024rethinking"></d-cite>, they proposed a bias mitigation solution that attenuates random bias in the latent features of the input prompts. We have viewed the problem from a slightly different angle, framing it as the disparity in bias levels for the attribute between the conditional distribution and the unconditional distribution.
